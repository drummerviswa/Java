...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <td><%= component.get("id") %></td>
                <td><%= component.get("name") %></td>
                <td><%= component.get("type") %></td>
                <td>$<%= component.get("price") %></td>
                 <td class="actions">
                    <button class="edit-button" onclick="location.href='edit.jsp?id=<%= component.get("id") %>'">Edit</button>
                    <button class="delete-button" onclick="location.href='index.jsp?action=delete&id=<%= component.get("id") %>'">Delete</button>
                </td>
            </tr>
            <% } %>
        </table>
